...
$('select.ah1').change(function(){
	...
	if (menenyDiv.find('span.ah1').text() == ''){
		console.log('ano');
		var text1 = '<p><strong>Ukázka:</strong></p><p>Článek si plyne veselým tempem. A teď si vzpomenu, že za chvíli bych mohl upozornit čtenáře na jiný článek svého webu. Takže to nějak uvedu. A potom <span>"</span><span class="ah1"><a href="/-nahled/' + cislo + '/" target="_blank">přesně tato slova v uvozovkách jsou klikací odkaz</a></span><span>":[xxx</span><span class="ah1-2">' + cislo + '</span><span>]</span> toto už odkazovací slova nejsou...</p><p>A ty uvozovky kolem těch klikacích slov i ta hranatá závorka se třemi iksky a číslem z textu zmizí, protože editor pochopí, že z toho má vyrobit klikací odkaz. A to číslo u těch třech iks editoru řekne, kde ten odkazovaný článek v místní databázi najde a jakou tomu aktivnímu odkazu má přiřadit internetovou adresu...</p>';
