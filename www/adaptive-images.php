<?php
// FOR DEBUGGING WITH TRACY UNCOMMENT NEXT 3 LINES:
...
$cache_path    = __DIR__ . '/../temp/ai-cache'; // where to store the generated re-sized images. Specify from your document root!
$jpg_quality   = 75; // the quality of any generated JPGs on a scale of 0 to 100
$sharpen       = TRUE; // Shrinking images can blur details, perform a sharpen on re-scaled images?
$watch_cache   = TRUE; // check that the adapted image isn't stale (ensures updated source images are re-cached)
$browser_cache = 60*60*24*30; // How long the BROWSER cache should last (seconds, minutes, hours, days. 30days by default)
